...
ActiveRecord::Schema[8.0].define(version: 2025_12_31_173100) do
  ...
  create_table "menu_items", force: :cascade do |t|
    ...
    t.string "image_url"
    t.text "allergens"
    t.integer "spice_level", default: 0
  ...
  create_table "staff_calls", force: :cascade do |t|
    t.bigint "tenant_id", null: false
    t.bigint "store_id", null: false
    t.bigint "table_id", null: false
    t.bigint "table_session_id", null: false
    t.integer "status", default: 0, null: false
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["store_id", "status", "created_at"], name: "index_staff_calls_on_store_status_created"
    t.index ["store_id"], name: "index_staff_calls_on_store_id"
    t.index ["table_id"], name: "index_staff_calls_on_table_id"
    t.index ["table_session_id", "status"], name: "index_staff_calls_on_session_status"
    t.index ["table_session_id"], name: "index_staff_calls_on_table_session_id"
    t.index ["tenant_id"], name: "index_staff_calls_on_tenant_id"
  end
  ...
  add_foreign_key "staff_calls", "stores"
  add_foreign_key "staff_calls", "table_sessions"
  add_foreign_key "staff_calls", "tables"
  add_foreign_key "staff_calls", "tenants"
